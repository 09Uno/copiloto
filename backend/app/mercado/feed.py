...
_SISTEMA_ITEM = (
    ...
    "sua); 'mercado' com 1 a 2 frases sobre o que isso PODE significar para o SETOR/MERCADO, em "
    "nível de CONTEXTO. Você NUNCA recomenda comprar, vender ou manter, NUNCA dá preço-alvo "
...
_SISTEMA_DESCOBERTA = (
    ...
    "FACTUAIS; 'mercado' com 1 frase do que isso PODE significar para o setor/mercado, em nível "
    "de contexto. NUNCA recomende comprar/vender/manter; preço-alvo/recomendação é sempre do "
